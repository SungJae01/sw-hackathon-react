...
import {curriculumData_ICT, featuresDataDepartment1} from "@/data/index.js";
...
import telecommunicationEngineeringIntro from "@/widgets/layout/telecommunicationEngineeringIntro.jsx";
import Curriculum from "@/widgets/layout/curriculum.jsx";
import DeanIntro_telecommunicationEngineering from "@/widgets/layout/DeanIntro_telecommunicationEngineering.jsx";
import TelecommunicationEngineeringIntro from "@/widgets/layout/telecommunicationEngineeringIntro.jsx";
        ...
        <>
            ...
            >
                <div className="container mx-auto max-w-screen-xl">
                    <TelecommunicationEngineeringIntro />
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-2 lg:gap-2 mt-12">
                        {featuresDataDepartment1.map(({ color, title, icon, path, description, links }, index) => (
                            <motion.div
                                key={title}
