...
import deanImg from "/img/Telecommunication_Engineering/ByunHeejeong.jpeg"; // 이미지 경로는 실제 프로젝트 구조에 맞게 확인해주세요.
                                        ...
                                        <div className="flex-grow">
                                            ...
                                            <div className="mt-4 pt-4 border-t border-gray-200">
                                                <Typography className="text-xs text-gray-600 leading-relaxed">
                                                    정보통신학부의 발전을 위해 힘쓰는 학부장님께 궁금한 점이나 건의사항이 있으시면 언제든지 연락주시기 바랍니다.
                                                </Typography>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className="w-full md:w-1/2 text-center md:text-left flex flex-col">
                        ...
                        >
                            <Typography color="gray" className="text-base md:text-lg text-gray-600 mb-6 md:mb-0 [@media(max-width:430px)]:text-[12px]">
                                ...
                                따뜻한 리더십과 혁신적인 교육 철학으로 정보통신학부를 이끌고 계십니다.
                            </Typography>
                        </motion.div>
                    </div>
                </div>
...
export default DeanIntro_telecommunicationEngineering;