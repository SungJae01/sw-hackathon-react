...
import {curriculumData_ICT, curriculumDataMediaSW} from "@/data/index.js";
...
const CurriculumMediaSW = () => {
    return (
        <section className="relative bg-white py-24 px-4">
            <div className="container mx-auto">
                <PageTitle section="과목 소개" heading="전공 교육 분야">
                    미디어SW학과는 소프트웨어 개발, 인공지능, 네트워크 등 정보기술 전반에 대한 이론과 실습을 통해 실무 능력을 갖춘 인재를 양성합니다.<br/>
                    4차 산업혁명 시대를 선도할 창의적 문제 해결력과 전문성을 배양하는 것을 목표로 합니다.
                </PageTitle>
                <div className="mx-auto mt-20 mb-48 grid max-w-5xl grid-cols-1 gap-16 md:grid-cols-2 lg:grid-cols-3">
                    {curriculumDataMediaSW.map(({ title, icon, description }) => (
                        <Card
                            key={title}
                            color="transparent"
                            shadow={false}
...
export default CurriculumMediaSW;