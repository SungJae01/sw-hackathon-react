...
FeatureCardDepartment3.defaultProps = {
    color: "blue",
};

FeatureCardDepartment3.propTypes = {
...
FeatureCardDepartment3.displayName = "/src/widgets/layout/feature-card-department3.jsx";

export default FeatureCardDepartment3;
